...
(setq org-agenda-files (quote ("~/Documents/orgfiles")))
(setq org-default-notes-file "~/Documents/orgfiles/notes.org")

(setq org-capture-templates
      '(("t" "todo" entry (file "~/Documents/orgfiles/newgtd.org")
	 "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
	("T" "Quick task" entry (file "~/Documents/orgfiles/newgtd.org")
	 "* TODO %^{Task}\n" :immediate-finish t)
